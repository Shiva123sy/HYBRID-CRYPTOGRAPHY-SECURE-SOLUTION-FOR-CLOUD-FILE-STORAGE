...
<%
  ...
  //String polatt1 = "D:/keypolicy_attri.txt";
    ...
    try {
        ...
        rs = st.executeQuery("select * from cloudadata where filename='" + filename + "' and skey = '"+dkey+"'");
     ...
     //  rs1 =st1.executeQuery("select * from upload where filename='" + filename + "'");
        ...
        if (rs.next()) {
           ...
           // if ( rs1.getString("privatekey").equals(rs.getString("skey")) )
               ...
               response.sendRedirect("download2act.jsp?" + filename + " ");
            }
            else 
            {
                response.sendRedirect("download.jsp?m1=key is not matched");
            }
